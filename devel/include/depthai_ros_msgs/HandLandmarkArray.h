...
struct HandLandmarkArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::depthai_ros_msgs::HandLandmark_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::depthai_ros_msgs::HandLandmark_<ContainerAllocator> >> _landmarks_type;
